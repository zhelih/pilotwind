...
(* OASIS_START *)
(* DO NOT EDIT (digest: 420a10e5f2ea30074b3ae905b832687b) *)
(*
...
let setup_t =
  {
     ...
     oasis_digest = Some "\135W1\002\129\212\172\006\188\2337t\186\200\217r";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
